...
public class BlahEcsFilter<T0, T1, T2, T3> : BlahEcsFilter<T0, T1, T2>
{
	...
	public new class Exc<E0, E1> : BlahEcsFilter<T0, T1, T2, T3>.Exc<E0>, IBlahEcsFilterExc { }
}
}