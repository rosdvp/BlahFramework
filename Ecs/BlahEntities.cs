...
namespace Blah.Ecs
{
public class BlahEntities
{
	private readonly BlahSet<BlahEnt> _set;
	...
	internal BlahEntities(int baseCapacity)
	{
		_set          = new BlahSet<BlahEnt>(baseCapacity, 0);
	...
	internal (BlahSet<BlahEnt> entities, int[] aliveIds, int aliveCount) GetAllAlive() 
